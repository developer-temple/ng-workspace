...
@Component({
  selector: 'dt-absolute-container',
  template: `
    <div #container>
...
export class DtAbsoluteContainerComponent extends BaseComponent implements AfterViewInit {
  ...
  private centeredTransform: string = 'translate(-50%, -50%)';
  ...
  public ngAfterViewInit(): void {
    if (this.containerRef && this.containerRef.nativeElement) {
      ...
      this.renderer.setStyle(el, StyleProps.POSITION, PositionTypes.ABSOLUTE);
      this.renderer.setStyle(el, StyleProps.TRANSFORM, this.centeredTransform);
